...
import 'package:storage/widgets/product_widget.dart';

class StorgeScreen extends StatefulWidget {
  const StorgeScreen({super.key});

  @override
  State<StorgeScreen> createState() => _StorgeScreenState();
}

class _StorgeScreenState extends State<StorgeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildAppBar(context, 'المخزن', 'assets/images/storage.png', true),
      body: Padding(
                  ...
                  if (state is ProductsLoading) {
                    ...
                    return GridView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          ProductWidget(productModel: filteredProducts[index]),
                    );
                  } else {
                    return Center(
                      child: Text(
